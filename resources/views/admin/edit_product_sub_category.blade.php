...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4">Edit Product Sub Category</h1>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ url('admin/update-product-sub-category/'.$subCategory->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row g-3">
                            <div class="col-lg-9">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="description" class="form-control" rows="3" required aria-required="true">{{ old('description', $subCategory->description) }}</textarea>
                                </div>
