        ...
        <div class="container-fluid px-4">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ url('admin/save-partner') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row g-3">
                            <div class="col-lg-9">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="url" name="website" id="website" class="form-control" value="" placeholder="https://example.com">
                                </div>
                                <div class="mb-3">
