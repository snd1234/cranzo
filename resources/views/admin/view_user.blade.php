                    ...
                    <div class="row g-3">
                        <!-- <div class="col-md-3 text-center">
                            @if(!empty($user->avatar))
                                <img src="{{ asset($user->avatar) }}" alt="Avatar" class="img-fluid rounded mb-2" style="max-height:180px;">
                            @else
                                <div class="bg-light rounded-circle d-flex align-items-center justify-content-center mx-auto mb-2" style="width:160px;height:160px;">
                                    <span class="fs-1 text-muted">{{ strtoupper(substr($user->name ?? 'U',0,1)) }}</span>
                                </div>
                            @endif
