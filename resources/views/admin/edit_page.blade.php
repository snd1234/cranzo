        ...
        <div class="container-fluid px-4">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ url('admin/update-page-data', $page->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-lg-9">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="content" id="contentEditor"  class="form-control" rows="10">{{ old('body', $page->body) }}</textarea>
                                </div>

                                {{-- Status --}}
                                <div class="mb-3">
                                    <label class="form-label">Status</label>
                                    @php $status = old('status', $page->status); @endphp
