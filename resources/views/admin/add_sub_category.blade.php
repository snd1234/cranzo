    ...
    <div class="container-fluid px-4">
        ...
        <div class="card shadow-sm">
            <div class="card-header bg-white border-bottom">
                <h5 class="mb-0"><i class="fas fa-plus me-2 text-primary"></i>Add New Sub Category</h5>
            </div>
                    ...
                    <div class="row g-3">
                        <div class="col-lg-8">
                            ...
                            <div class="d-flex justify-content-end gap-2 mt-3">
                                ...
                                <button type="submit" class="btn btn-primary"><i class="fas fa-save me-2"></i>Add Sub Category</button>
                            </div>
                        </div>
                    </div>
                </form>
