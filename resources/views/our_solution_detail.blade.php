                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                        <div class="solution-detail-card text-center p-6 bg-white rounded-lg shadow hover:shadow-lg transition duration-300">
                            <div class="product-img">
                              <a href="#" target="_self">
                                <img src="{{ asset('front/images/Zorbax.png') }}" alt="Zorbax" class="mx-auto">
                              </a>
                            </div>
                            <div class="product-title">
                              <a href="#" target="_self">Zorbax</a>
                            </div>
                        </div>
                        <div class="solution-detail-card text-center p-6 bg-white rounded-lg shadow hover:shadow-lg transition duration-300">
                            <div class="product-img">
